		...
		<div class="row section recentworks topspace">
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					...
					<span class="details"><a href="">Computer Networking</a></span>
					<h4></h4>
					<p></p>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					...
					<span class="details"><a href="">Software Testing</a></span>
					<h4></h4>
					<p></p>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					...
					<span class="details"><a href="">Discrete Mathematics</a></span>
					<h4></h4>
					<p></p>
				</div>
